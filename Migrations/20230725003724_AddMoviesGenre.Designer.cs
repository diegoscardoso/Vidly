...
namespace Vidly.Migrations
{
    ...
    [Migration("20230725003724_AddMoviesGenre")]
    partial class AddMoviesGenre
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Vidly.Models.Movie", b =>
                {
                    ...
                    b.HasIndex("MoviesGenreId");

                    b.ToTable("Movies");
                });

            modelBuilder.Entity("Vidly.Models.MoviesGenre", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Vidly.Models.Movie", b =>
                {
                    b.HasOne("Vidly.Models.MoviesGenre", "Genre")
                        .WithMany()
                        .HasForeignKey("MoviesGenreId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
